...
import { BarChart3, Ship, ClipboardList, ArrowUpRight, ClipboardPenLine } from "lucide-react";
...
export default function Page({
  ...
  return (
    <div className="p-8 bg-slate-50 min-h-screen">
      ...
      <Button href="/empadronamiento/registrar_datos" icon={<ClipboardPenLine size={16} />}>
